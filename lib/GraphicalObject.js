...
class GraphicalObject {
    ...
    get selected() {
        return this._selected.valueOf();
    }
    set selected(newVal) {
        this._selected = newVal;

        if (this.onSelectionChange != null) {
            this.onSelectionChange(this, newVal);
        }
    ...
    get interimSelected() {
        return this._interimSelected.valueOf();
    }
    set interimSelected(newVal) {
        this._interimSelected = newVal;
        this.propagate("interimSelected"); 
    }
